    ...
    <div className="min-h-screen bg-surface-0 flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <p className="text-sm text-text-muted mb-6">Access your SOC workspace</p>
          ...
          <div className="mt-4 text-center text-sm text-text-secondary">
            Don't have an account? <button type="button" onClick={() => navigate('/register')} className="text-forecast hover:text-forecast-bright hover:underline">Sign up</button>
          </div>
        </motion.div>
      </div>
    </div>
